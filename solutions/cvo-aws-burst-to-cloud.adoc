...
summary: 本文支持NetApp Cloud Volumes ONTAP for AWS Automation Solution， NetApp客户可通过NetApp Console自动化中心获取该解决方案。 
---
...
[role="lead"]
本文支持NetApp Cloud Volumes ONTAP for AWS 自动化解决方案， NetApp客户可通过NetApp Console自动化中心获取该解决方案。
...
.开始之前
* 您必须下载 link:https://console.netapp.com/automationHub["Cloud Volumes ONTAP AWS—突发到云"^] 通过控制台 Web 用户界面实现自动化解决方案。该解决方案打包如下： `cvo_aws_flexcache.zip`。
